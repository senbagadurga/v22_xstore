package mto.pos.ws.order.orderupdate;
...
public class MtoOrposExecuteInputRequestPreparer {

	public ORPOSExecuteInput buildOrderUpdateRequestPreparer(MtoOrderList argOrderSelected) {
		 ...
		 OrderEntryOrdersData orderEntry = new OrderEntryOrdersData();
			 ...
			 orderEntry.setStatus(MtoOrderConstants.ORDER_UPDATE_STATUS);
